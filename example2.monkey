...
Class MyApp Extends App
	...
	Method OnCreate()
		...
		'Try
			...
			AES.Size(256)
			Local encrypted:String=AES.Encode("test,1,2,3,4,5,", "12345678")
			Print "256 Bit: " + AES.Decode(encrypted, "12345678")
			Print "256 Bit: " + AES.Decode("U2FsdGVkX1+2NL9YzUw+LDri6g6i9sL+1ivKLFRr2io=", "12345678")
			...
			testString=AES.Encode("testing123!", "12345678")
...
'		End
	...
	Method OnUpdate()
		'TEST Android Crash
		Local tmpString:String=AES.Decode(testString, "123"+String.FromChar(Rnd(32,255))+String.FromChar(Rnd(32,255))+String.FromChar(Rnd(32,255))+String.FromChar(Rnd(32,255)))
	End Method
End
